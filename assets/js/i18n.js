...
(() => {
  ...
  const IT = {
    ...
    projects: {
      ...
      hopy: { title: "Hopy", desc: "Spot pubblicitario generato con l'intelligenza artificiale per Hopy, linea cosmetica a base di canapa di TiliLab." },
  ...
  const OVERRIDES = {
    en: {
      ...
      projects: {
        ...
        hopy: { desc: "AI-generated ad for Hopy, a hemp-based cosmetic line by TiliLab." },
    ...
    de: {
      ...
      projects: {
        ...
        hopy: { desc: "KI-generierter Werbespot für Hopy, eine Kosmetiklinie auf Hanfbasis von TiliLab." },
    ...
    es: {
      ...
      projects: {
        ...
        hopy: { desc: "Spot publicitario generado con inteligencia artificial para Hopy, línea cosmética a base de cáñamo de TiliLab." },
    ...
    fr: {
      ...
      projects: {
        ...
        hopy: { desc: "Spot publicitaire généré par intelligence artificielle pour Hopy, gamme cosmétique à base de chanvre de TiliLab." },
    ...
    pt: {
      ...
      projects: {
        ...
        hopy: { desc: "Anúncio gerado com inteligência artificial para a Hopy, linha cosmética à base de cânhamo da TiliLab." },
    ...
    ro: {
      ...
      projects: {
        ...
        hopy: { desc: "Reclamă generată cu inteligență artificială pentru Hopy, linie cosmetică pe bază de cânepă de la TiliLab." },
    ...
    nl: {
      ...
      projects: {
        ...
        hopy: { desc: "AI-gegenereerde reclame voor Hopy, een cosmeticalijn op hennepbasis van TiliLab." },
    ...
    zh: {
      ...
      projects: {
        ...
        hopy: { desc: "为 TiliLab 旗下大麻基化妆品品牌 Hopy 制作的 AI 生成广告。" },
