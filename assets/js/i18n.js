...
(() => {
  ...
  const IT = {
    ...
    projects: {
      ...
      corolla: { title: "Corolla", desc: "Cortometraggio surreale generato con l'intelligenza artificiale, tra volti sospesi e corone di fiori." },
      ...
      hopy: { title: "Hopy", desc: "Spot pubblicitario generato con l'intelligenza artificiale per Hopy, linea cosmetica a base di canapa di Enzima." },
  ...
  const OVERRIDES = {
    en: {
      ...
      skills: {
        ...
        label04: "UI/UX Design", label05: "Video Mapping", label06: "Social & Advertising Content",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Surreal short film generated with artificial intelligence, between floating faces and flower crowns." },
        ...
        hopy: { desc: "AI-generated ad for Hopy, a hemp-based cosmetic line by Enzima." },
    ...
    de: {
      ...
      skills: {
        ...
        label04: "UI/UX Design", label05: "Video Mapping", label06: "Social- & Werbeinhalte",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Surrealer Kurzfilm, generiert mit künstlicher Intelligenz, zwischen schwebenden Gesichtern und Blumenkränzen." },
        ...
        hopy: { desc: "KI-generierter Werbespot für Hopy, eine Kosmetiklinie auf Hanfbasis von Enzima." },
    ...
    es: {
      ...
      skills: {
        ...
        label04: "Diseño UI/UX", label05: "Video Mapping", label06: "Contenidos sociales y publicitarios",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Cortometraje surrealista generado con inteligencia artificial, entre rostros suspendidos y coronas de flores." },
        ...
        hopy: { desc: "Spot publicitario generado con inteligencia artificial para Hopy, línea cosmética a base de cáñamo de Enzima." },
    ...
    fr: {
      ...
      skills: {
        ...
        label04: "UI/UX Design", label05: "Video Mapping", label06: "Contenus social & publicitaires",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Court-métrage surréaliste généré par intelligence artificielle, entre visages suspendus et couronnes de fleurs." },
        ...
        hopy: { desc: "Spot publicitaire généré par intelligence artificielle pour Hopy, gamme cosmétique à base de chanvre d'Enzima." },
    ...
    pt: {
      ...
      skills: {
        ...
        label04: "Design UI/UX", label05: "Video Mapping", label06: "Conteúdos sociais e publicitários",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Curta-metragem surrealista gerada com inteligência artificial, entre rostos suspensos e coroas de flores." },
        ...
        hopy: { desc: "Anúncio gerado com inteligência artificial para a Hopy, linha cosmética à base de cânhamo da Enzima." },
    ...
    ro: {
      ...
      skills: {
        ...
        label04: "UI/UX Design", label05: "Video Mapping", label06: "Conținut social și publicitar",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Scurtmetraj suprarealist generat cu inteligență artificială, între chipuri suspendate și coroane de flori." },
        ...
        hopy: { desc: "Reclamă generată cu inteligență artificială pentru Hopy, linie cosmetică pe bază de cânepă de la Enzima." },
    ...
    nl: {
      ...
      skills: {
        ...
        label04: "UI/UX Design", label05: "Video Mapping", label06: "Social & reclame-content",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "Surrealistische korte film gegenereerd met kunstmatige intelligentie, tussen zwevende gezichten en bloemenkransen." },
        ...
        hopy: { desc: "AI-gegenereerde reclame voor Hopy, een cosmeticalijn op hennepbasis van Enzima." },
    ...
    zh: {
      ...
      skills: {
        ...
        label04: "UI/UX 设计", label05: "投影映射（Video Mapping）", label06: "社交与广告内容",
      },
      globe: {
      ...
      projects: {
        ...
        corolla: { desc: "由人工智能生成的超现实短片，漂浮的面孔与花冠交织其间。" },
        ...
        hopy: { desc: "为 Enzima 旗下大麻基化妆品品牌 Hopy 制作的 AI 生成广告。" },
