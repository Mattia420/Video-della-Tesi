...
(() => {
  ...
  lightbox.innerHTML = `
    <button class="ai-lightbox__close" type="button" aria-label="Close">&times;</button>
  ...
  function openLightbox(data) {
    ...
    if (data.type === 'figma' && data.figmaUrl) {
      ...
      let spinner = null;
      if (showLoadingUI) {
        loadingEl.textContent = 'Loading the prototype… this may take a few seconds.';
      ...
      const labels = { figma: 'Prototype coming soon', image: 'Artwork coming soon' };
      placeholder.textContent = labels[data.type] || 'Video coming soon';
  ...
  /* ---------- content data ---------- */
  const AI_DESCS = [
    'Social campaign post generated with AI.',
    'Creative for paid ads.',
    'Video content developed with artificial intelligence.',
    'Visual for a product launch.',
  ];

  const AI_OVERRIDES = {
    0: {
      title: 'Telemea — Solomonescu',
      desc: 'Advertising spot generated with artificial intelligence for Telemea by Solomonescu, a Romanian dairy company, made during a work period in Romania.',
    ...
    1: {
      ...
      desc: 'Advertising spot generated with artificial intelligence for Cascaval Dalia, a cheese by Lunca Ilvei, a Romanian dairy company, made during a work period in Romania.',
      video: '../assets/video/lunca-ilvei-cheese.mp4',
      cover: '../assets/img/lunca-ilvei-cover.webp?v=2',
    },
    2: {
      title: 'Black & White',
      desc: 'Visual content generated with artificial intelligence.',
    ...
    4: {
      ...
      desc: 'Advertising spot generated with artificial intelligence for the Raclette line by Lunca Ilvei, a Romanian dairy company, made during a work period in Romania.',
      video: '../assets/video/raclette-cheese.mp4',
      cover: '../assets/img/raclette-cheese-cover.webp?v=2',
    },
    5: {
      title: 'Red Bull Green Edition — Spot',
      desc: 'Advertising spot concept generated with artificial intelligence.',
    ...
    7: {
      title: 'Hopy',
      desc: 'Advertising spot generated with artificial intelligence for Hopy, a hemp-based cosmetics line by Enzima.',
  ...
  const AI_ITEMS = Array.from({ length: 8 }, (_, i) => ({
    title: `AI Content ${String(i + 1).padStart(2, '0')}`,
  ...
  const OTHER_ITEMS = [
    {
      ...
      desc: 'Poster for a vinyl open decks night, custom-designed for the event\'s brand.',
      type: 'image',
    ...
    },
    {
      ...
      desc: 'Poster for a tekno event with live music, custom-designed for the night\'s brand.',
      type: 'image',
      category: 'Graphic Design',
      badge: 'GD',
    ...
    {
      title: 'Touch of Beauty — Presentation',
      desc: 'Presentation of the Touch of Beauty brand, navigable slide by slide.',
      type: 'figma',
      category: 'Graphic Design',
      badge: 'GD',
    ...
    },
    {
      ...
      // "Artwork coming soon" placeholder) until then.
      title: 'Energic Swirl',
      desc: 'Vinyl cover in two color variants, green and purple.',
      type: 'image',
      category: 'Graphic Design',
      badge: 'GD',
      ...
      gallery: [
        { image: '../assets/img/energic-swirl-purple.webp', cover: '../assets/img/energic-swirl-purple-cover.webp?v=2', label: 'Purple' },
        { image: '../assets/img/energic-swirl-green.webp', cover: '../assets/img/energic-swirl-green-cover.webp?v=2', label: 'Green' },
      ],
    },
    {
      title: 'Smart Home — App Design',
      desc: 'Interactive prototype of a smart home management app, navigable screen by screen.',
      type: 'figma',
    ...
    },
    {
      ...
      desc: 'Interactive prototype, navigable screen by screen.',
      type: 'figma',
      category: 'UI/UX Design',
      badge: 'UX',
    ...
    },
    {
      ...
      desc: 'Interactive prototype of the Festillu website, an imaginary festival, navigable page by page.',
      type: 'figma',
      category: 'UI/UX Design',
      badge: 'UX',
    ...
    },
    {
      ...
      desc: 'Motion design for the promotion of a video production studio, spanning editing, cutting and sound design.',
      type: 'video',
    ...
    },
    {
      ...
      desc: 'Animated explainer video for Accademia di Impresa, about legal business structures and corporate choices.',
      type: 'video',
      category: 'Motion Design',
      badge: 'VID',
      wide: true,
