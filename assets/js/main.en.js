...
/* =========================================================
   CONTACT HEADING — handwriting-style rotating word ("...Let's talk
   and [create/design/...] together."). Each word is "drawn" as an SVG
   ...
   "together." reflows smoothly instead of jumping.
   ========================================================= */
(() => {
  ...
  const words = ['create', 'design', 'think', 'organize', 'generate'];
  let i = 0;
